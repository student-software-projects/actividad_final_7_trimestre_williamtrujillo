            ...
            <div class="col-md-4">
                <form action="{{ route('propietario.store') }}" method="post">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <input name="num_cedula" id="num_cedula" type="text" class="form-control" required>
                    </div>
                    <div class="form-group mt-5">
                        <label for="prim_nombre">Primer Nombre</label>
                        <input name="prim_nombre" id="prim_nombre" type="text" class="form-control" required>
                    </div>
                    <div class="form-group mt-5">
                        <label for="seg_nombre">Segundo Nombre</label>
                        <input name="seg_nombre" id="seg_nombre" type="text" class="form-control" required>
                    </div>
                    <div class="form-group mt-5">
                    ...
                    <hr>
                    <button type="submit" class="btn btn-primary">GUARDAR NUEVO PROPIETARIO</button>
